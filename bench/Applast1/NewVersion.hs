module NewVersion where

import Stream
import Control.Monad
import Term

applastoI x0 = msum [do {guard (x0 == Nil); return ()},
                     do {let {x6 = Zero};
                         let {x5 = Succ x6};
                         let {x8 = Nil};
                         (x7, x1) <- case x0 of
                     ...
                     do {(x2, x1) <- case x0 of
                         ...
                         appendoLastoI x1;
                         return ()}]
_appendoII x0 x1 = msum [do {let {x15 = Zero};
                             let {x14 = Succ x15};
                             let {x16 = Nil};
                             (x17, x18) <- case x1 of
                         ...
                         do {(x2, x3) <- case x1 of
                             ...
                             _appendoII x4 x3;
                             return ()}]
appendoLastoI x0 = msum [do {let {x11 = Zero};
                             let {x10 = Succ x11};
                             let {x12 = Nil};
                             let {x9 = Cons x10 x12};
                             lastoI x9;
                         ...
                         do {(x1, x2) <- case x0 of
                             ...
                             lastoI x13;
                             return ()}]
_appendoIO x0 = msum [do {let {x15 = Zero};
                          let {x14 = Succ x15};
                          let {x16 = Nil};
                          guard (x0 == Nil);
                          let {x17 = x14};
                      ...
                      do {(x19, x4) <- case x0 of
                          ...
                          let {x1 = Cons x2 x3};
                          return x1}]
applastoO gen_applastoO_x2 gen_lastoO_x1 = msum [do {let {x0 = Nil};
                                                     return x0},
                                                 do {let {x6 = Zero};
                                                     let {x5 = Succ x6};
                                                     let {x8 = Nil};
                                                 ...
                                                 do {x1 <- appendoLastoO gen_lastoO_x1;
                                                     (x0, x2) <- do {x2 <- gen_applastoO_x2;
                                                                     ...
                                                                     return (x0, x2)};
                                                     return x0}]
_appendoOI x1 = msum [do {let {x15 = Zero};
                          let {x14 = Succ x15};
                          let {x16 = Nil};
                          let {x0 = Nil};
                          (x17, x18) <- case x1 of
                      ...
                      do {(x2, x3) <- case x1 of
                          ...
                          let {x0 = Cons x19 x4};
                          return x0}]
appendoLastoO gen_lastoO_x1 = msum [do {let {x0 = Nil};
                                        let {x11 = Zero};
                                        let {x10 = Succ x11};
                                        let {x12 = Nil};
                                        let {x9 = Cons x10 x12};
                                    ...
                                    do {x13 <- lastoO gen_lastoO_x1;
                                        ...
                                        let {x0 = Cons x1 x2};
                                        return x0}]
lastoI x0 = msum [do {let {x21 = Zero};
                      let {x20 = Succ x21};
                      let {x22 = Nil};
                      (x23, x24) <- case x0 of
                  ...
                  do {(x1, x2) <- case x0 of
                      ...
                      lastoI x2;
                      return ()}]
lastoO gen_lastoO_x1 = msum [do {let {x21 = Zero};
                                 let {x20 = Succ x21};
                                 let {x22 = Nil};
                                 let {x23 = x20};
                                 let {x24 = x22};
