module Deforestation2_online where

import Stream
import Control.Monad
import Term

rrI x0 = Immature $ msum [do {(x11, x12) <- case x0 of
               ...
               do {(x3, x14) <- case x0 of
                   ...
                   neqRRIII x3 x4 x5;
                   return ()}]
neqRRIII x0 x1 x2 = Immature $ msum [do {let {x62 = O};
                              x3 <- case x1 of
...
neqII x0 x1 = Immature $ msum [do {x2 <- case x1 of
                    ...
                    do {x4 <- case x1 of
                        ...
                        neqII x5 x4;
                        return ()}]
rRII x0 x1 = Immature $ msum [do {let {x23 = O};
                       let {x22 = S x23};
                       let {x25 = O};
                       let {x29 = O};
                       let {x28 = S x29};
                   ...
                   do {let {x42 = O};
                       ...
                       rII x38 x40;
                       return ()}]
rII x0 x1 = Immature $ msum [do {guard (x1 == Nil);
                      guard (x0 == Nil);
                      return ()},
                  do {(x2, x3) <- case x1 of
                  ...
                  do {(x5, x6) <- case x1 of
                      ...
                      rII x61 x6;
                      return ()}]
rIO x0 = Immature $ msum [do {let {x1 = Nil}; guard (x0 == Nil); return x1},
               ...
               do {(x59, x60) <- case x0 of
                   ...
                   let {x1 = Cons x5 x6};
                   return x1}]
rrO gen_neqIO_x2 gen_rrO_x1 gen_rrO_x13 = Immature $ msum [do {(x10,
                                                ...
                                                do {(x14, x13) <- do {x13 <- gen_rrO_x13;
                                                    ...
                                                    let {x0 = Cons x3 x14};
                                                    return x0}]
neqRROII x1 x2 gen_neqIO_x2 = Immature $ msum [do {let {x0 = O};
                                        let {x62 = O};
                                        x3 <- case x1 of
                                              {S y3 -> return y3; _ -> mzero};
                                        let {x64 = S x3};
                                    ...
                                    do {x5 <- case x1 of
                                        ...
                                        let {x0 = S x71};
                                        return x0}]
rRIO x0 gen_neqIO_x2 = Immature $ msum [do {let {x23 = O};
                                 let {x22 = S x23};
                                 let {x25 = O};
                                 let {x29 = O};
                                 let {x28 = S x29};
                             ...
                             do {let {x42 = O};
                                 ...
                                 let {x1 = Cons x5 x36};
                                 return x1}]
neqIO x0 gen_neqIO_x2 = Immature $ msum [do {guard (x0 == O);
                              ...
                              do {x5 <- case x0 of
                                  ...
                                  let {x1 = S x4};
                                  return x1}]
rOI x1 gen_neqIO_x2 = Immature $ msum [do {let {x0 = Nil};
                                guard (x1 == Nil);
                                return x0},
                            do {(x2, x3) <- case x1 of
                                            {Cons y2 y3 -> return (y2, y3); _ -> mzero};
                            ...
                            do {(x5, x6) <- case x1 of
                                ...
                                let {x0 = Cons x59 x60};
                                return x0}]
rROI x1 gen_neqIO_x2 = Immature $ msum [do {let {x23 = O};
                                 let {x22 = S x23};
                                 let {x25 = O};
                                 let {x29 = O};
                                 let {x28 = S x29};
