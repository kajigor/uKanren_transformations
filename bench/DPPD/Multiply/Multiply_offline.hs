module Multiply_offline where

import Stream
import Control.Monad
import Term

multiplyddsII x0 x1 = Immature $ msum [do {x8 <- case x1 of
                            ...
                            do {let {x58 = O};
                                ...
                                guard (x76 == x60);
                                return ()}]
____multiplysdsI x0 = Immature $ msum [do {guard (x0 == O); return ()}]
___multiplysdsI x0 = Immature $ msum [do {guard (x0 == O); return ()}]
__multiplysdsI x0 = Immature $ msum [do {guard (x0 == O); return ()}]
_multiplysdsI x0 = Immature $ msum [do {guard (x0 == O); return ()}]
multiplyddsIO x0 = Immature $ msum [do {guard (x0 == O);
                             x2 <- multiplysdsO;
                             let {x7 = S x2};
                             let {x8 = x7};
                             let {x1 = S x8};
                         ...
                         do {let {x58 = O};
                             ...
                             let {x1 = S x59};
                             return x1}]
____multiplysdsO = Immature $ msum [do {let {x0 = O}; return x0}]
___multiplysdsO = Immature $ msum [do {let {x0 = O}; return x0}]
__multiplysdsO = Immature $ msum [do {let {x0 = O}; return x0}]
_multiplysdsO = Immature $ msum [do {let {x0 = O}; return x0}]
multiplyddsOI x1 = Immature $ msum [do {let {x0 = O};
                             x8 <- case x1 of
                                   {S y8 -> return y8; _ -> mzero};
                             let {x7 = x8};
                             x2 <- case x7 of
                         ...
                         do {let {x58 = O};
                             ...
                             let {x0 = S x76};
                             return x0}]
multiplyddsOO = Immature $ msum [do {let {x0 = O};
                          x2 <- multiplysdsO;
                          let {x7 = S x2};
                          let {x8 = x7};
                          let {x1 = S x8};
                      ...
                      do {let {x58 = O};
                          ...
                          let {x0 = S x76};
                          return (x0, x1)}]
multiplysdsI x0 = Immature $ msum [do {x1 <- case x0 of
                                  {S y1 -> return y1; _ -> mzero};
                            multiplysdsI x1;
                            return ()}]
multiplysdsO = Immature $ msum [do {x1 <- multiplysdsO;
                         let {x0 = S x1};
                         return x0}]