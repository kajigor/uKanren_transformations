module Remove2_online where

import Stream
import Control.Monad
import Term

rrI x0 = Immature $ msum [do {(x1, x9) <- case x0 of
                   ...
                   gGIII x1 x2 x3;
                   return ()}]
gGIII x0 x1 x2 = Immature $ msum [do {guard (x0 == x1);
                           (x3, x4) <- case x2 of
                                       {Cons y3 y4 -> return (y3, y4); _ -> mzero};
                           hGIII x1 x3 x4;
                           return ()},
                       do {_neqHGIII x0 x1 x2; return ()}]
_neqHGIII x0 x1 x2 = Immature $ msum [do {let {x80 = Zero};
                               x3 <- case x1 of
                           ...
                           do {x4 <- case x1 of
                               ...
                               hGIII x84 x85 x2;
                               return ()}]
hGIII x0 x1 x2 = Immature $ msum [do {let {x11 = Nil};
                           let {x12 = Nil};
                           guard (x2 == Nil);
                           let {x10 = x1};
                       ...
                       do {(x3, x4) <- case x2 of
                           ...
                           _gGIIII x0 x1 x3 x4;
                           return ()}]
_______gIIIII x0 x1 x2 x3 x4 = Immature $ msum [do {guard (x1 == x0);
                                         let {x60 = Zero};
                                         let {x63 = Zero};
                                         let {x67 = Zero};
                                         let {x66 = Succ x67};
                                     ...
                                     do {let {x70 = Zero};
                                         ...
                                         guard (x72 == x71);
                                         return ()}]
_____gIIII x0 x1 x2 x3 = Immature $ msum [do {guard (x0 == x2);
                                   (x28, x4) <- case x1 of
                               ...
                               do {neqII x0 x2;
                                   ...
                                   hIII x2 x3 x4;
                                   return ()}]
_gGIIII x0 x1 x2 x3 = Immature $ msum [do {guard (x1 == x2);
                                fGIII x0 x3 x2;
                                return ()},
                            do {neqHGIIII x0 x1 x2 x3; return ()}]
fII x0 x1 = Immature $ msum [do {guard (x1 == Nil);
                      guard (x0 == Nil);
                      return ()},
                  do {(x2, x3) <- case x0 of
                                  {Cons y2 y3 -> return (y2, y3); _ -> mzero};
                      hIII x2 x3 x1;
                      return ()}]
fGIII x0 x1 x2 = Immature $ msum [do {let {x14 = Nil};
                           let {x15 = Nil};
                           guard (x1 == Nil);
                           let {x13 = x2};
                       ...
                       do {(x3, x4) <- case x1 of
                           ...
                           return ()}]
__hGIIIII x0 x1 x2 x3 x4 = Immature $ msum [do {let {x43 = Nil};
                                     let {x42 = Cons x2 x43};
                                     let {x46 = Nil};
                                     guard (x1 == Nil);
                                     let {x45 = x2};
                                 ...
                                 do {(x5, x6) <- case x1 of
                                     ...
                                     return ()}]
___gGIIIIII x0 x1 x2 x3 x4 x5 = Immature $ msum [do {guard (x1 == x4);
                                      ...
                                      do {neqII x1 x4;
                                          ...
                                          return ()}]
_fGIIIII x0 x1 x2 x3 x4 = Immature $ msum [do {let {x52 = Nil};
                                    let {x51 = Cons x4 x52};
                                    let {x55 = Nil};
                                    guard (x3 == Nil);
                                    let {x54 = x4};
                                ...
                                do {(x5, x6) <- case x3 of
                                    ...
                                    return ()}]
hIII x0 x1 x2 = Immature $ msum [do {let {x25 = Nil};
                          (x26, x27) <- case x2 of
                      ...
                      do {(x3, x4) <- case x1 of
                          ...
                          return ()}]
hIIO x0 x1 = Immature $ msum [do {let {x25 = Nil};
                       guard (x1 == Nil);
                       let {x26 = x0};
                       let {x27 = x25};
                       let {x2 = Cons x26 x27};
                   ...
                   do {(x3, x4) <- case x1 of
                       ...
                       return x2}]
_____gIOII x0 x2 x3 = Immature $ msum [do {guard (x0 == x2);
                                let {x28 = x2};
                                x4 <- fIO x3;
                                let {x1 = Cons x28 x4};
                                return x1},
                            do {neqII x0 x2;
                                ...
                                let {x1 = Cons x29 x4};
                                return x1}]
fIO x0 = Immature $ msum [do {let {x1 = Nil}; guard (x0 == Nil); return x1},
               do {(x2, x3) <- case x0 of
                               {Cons y2 y3 -> return (y2, y3); _ -> mzero};
                   x1 <- hIIO x2 x3;
                   return x1}]
neqII x0 x1 = Immature $ msum [do {x2 <- case x1 of
                    ...
                    do {x3 <- case x1 of
                        ...
                        neqII x4 x3;
                        return ()}]
neqHGIIII x0 x1 x2 x3 = Immature $ msum [do {let {x31 = Zero};
                                  let {x32 = Zero};
                                  x4 <- case x2 of
                                        {Succ y4 -> return y4; _ -> mzero};
                                  let {x30 = Succ x4};
                              ...
                              do {x5 <- case x2 of
                                  ...
                                  return ()}]
rrO gen_rrO_x8 = Immature $ msum [do {(x9, x8) <- do {x8 <- gen_rrO_x8;
                                           return (x8, x8)};
                           (x2, x3) <- case x8 of
                                       {Cons y2 y3 -> return (y2, y3); _ -> mzero};
                           x1 <- gGOII x2 x3;
                           let {x0 = Cons x1 x9};
                           return x0}]
gGOII x1 x2 = Immature $ msum [do {(x3, x4) <- case x2 of
                                    {Cons y3 y4 -> return (y3, y4); _ -> mzero};
                        hGIII x1 x3 x4;
                        let {x0 = x1};
                        return x0},
                    do {x0 <- _neqHGOII x1 x2; return x0}]
_neqHGOII x1 x2 = Immature $ msum [do {let {x0 = Zero};
                            let {x80 = Zero};
                            x3 <- case x1 of
                                  {Succ y3 -> return y3; _ -> mzero};
                            let {x81 = Succ x3};
                        ...
                        do {x4 <- case x1 of
                            ...
                            let {x0 = Succ x86};
                            return x0}]
hGOII x1 x2 = Immature $ msum [do {let {x11 = Nil};
                        let {x12 = Nil};
                        guard (x2 == Nil);
                        let {x10 = x1};
                    ...
                    do {(x3, x4) <- case x2 of
                        ...
                        x0 <- _gGOIII x1 x3 x4;
                        return x0}]
_______gOIIII x1 x2 x3 x4 = Immature $ msum [do {let {x60 = Zero};
                                      let {x63 = Zero};
                                      let {x67 = Zero};
                                      let {x66 = Succ x67};
                                      let {x65 = Succ x66};
                                  ...
                                  do {let {x70 = Zero};
                                      ...
                                      let {x0 = Succ x72};
                                      return x0}]
_gGOIII x1 x2 x3 = Immature $ msum [do {guard (x1 == x2);
                             x0 <- fGOII x3 x2;
                             return x0},
                         do {x0 <- neqHGOIII x1 x2 x3; return x0}]
fGOII x1 x2 = Immature $ msum [do {let {x14 = Nil};
                        let {x15 = Nil};
                        guard (x1 == Nil);
                        let {x13 = x2};
                    ...
                    do {(x3, x4) <- case x1 of
                        ...
                        return x0}]
__hGOIIII x1 x2 x3 x4 = Immature $ msum [do {let {x43 = Nil};
                                  let {x42 = Cons x2 x43};
                                  let {x46 = Nil};
                                  guard (x1 == Nil);
                                  let {x45 = x2};
                              ...
                              do {(x5, x6) <- case x1 of
                                  ...
                                  return x0}]
___gGOIIIII x1 x2 x3 x4 x5 = Immature $ msum [do {guard (x1 == x4);
                                   ...
                                   do {neqII x1 x4;
                                       ...
                                       return x0}]
_fGOIIII x1 x2 x3 x4 = Immature $ msum [do {let {x52 = Nil};
                                 let {x51 = Cons x4 x52};
                                 let {x55 = Nil};
                                 guard (x3 == Nil);
                                 let {x54 = x4};
                             ...
                             do {(x5, x6) <- case x3 of
                                 ...
                                 return x0}]
neqHGOIII x1 x2 x3 = Immature $ msum [do {let {x31 = Zero};
                               let {x32 = Zero};
                               x4 <- case x2 of
                                     {Succ y4 -> return y4; _ -> mzero};
                               let {x30 = Succ x4};
