module RotatePrune_offline where

import Stream
import Control.Monad
import Term

pruneI x0 = Immature $ msum [do {let {x7 = O};
                      let {x6 = Leaf x7};
                      let {x9 = O};
                      let {x8 = S x9};
                      let {x12 = O};
                  ...
                  do {let {x52 = O};
                      ...
                      (x1, x2) <- case x60 of
                                  {Tree y1 y61 y2 -> do {guard (x61 == y61); return (y1, y2)};
                                   _ -> mzero};
                      return ()}]
pruneO gen_pruneO_x30 gen_pruneO_x35 gen_pruneO_x50 gen_pruneO_x60 = Immature $ msum [do {let {x7 = O};
                                                                               let {x6 = Leaf x7};
                                                                               let {x9 = O};
                                                                               let {x8 = S x9};
                                                                               let {x12 = O};
