module RotatePrune_online where

import Stream
import Control.Monad
import Term

pruneI x0 gen_pruneI_x15 = Immature $ msum [do {let {x4 = O};
                                     let {x3 = Leaf x4};
                                     let {x6 = O};
                                     let {x5 = S x6};
                                     let {x9 = O};
                                 ...
                                 do {let {x16 = O};
                                     ...
                                     (x2, x3) <- case x15 of
                                                 {Tree y2 y16 y3 -> do {guard (x16 == y16);
                                                  ...
                                                  _ -> mzero};
                                     return ()}]
_pruneI x0 = Immature $ msum [do {let {x26 = O};
                       x27 <- case x0 of
                   ...
                   do {let {x28 = O};
                       ...
                       guard (x29 == x28);
                       return ()}]
pruneO gen__pruneO_x1 gen__pruneO_x2 gen_pruneO_x14 = Immature $ msum [do {let {x4 = O};
                                                                let {x3 = Leaf x4};
                                                                let {x6 = O};
                                                                let {x5 = S x6};
                                                                let {x9 = O};
                                                            ...
                                                            do {let {x16 = O};
                                                                ...
                                                                (x2, x3) <- case x15 of
                                                                            {Tree y2
                                                                             ...
                                                                             _ -> mzero};
                                                                return x0}]
_pruneO gen__pruneO_x1 gen__pruneO_x2 = Immature $ msum [do {let {x26 = O};
                                                  let {x27 = x26};
                                                  let {x0 = Leaf x27};
                                                  return x0},
                                              do {let {x28 = O};
