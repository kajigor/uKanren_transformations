...
double_appendoIIIOnline :: MonadPlus m => Term -> Term -> Term -> m ()
double_appendoIIIOnline x0 x1 x2 = msum [do {appendoII x2 x1;
                                       guard (x0 == Nil);
                                       return ()},
                                   do {let {x5 = O};
                                       let {x4 = S x5};
...
double_appendoIIOOnline :: MonadPlus m => Term -> Term -> m Term               
double_appendoIIOOnline x0 x1 = msum [do {guard (x0 == Nil);
                                    x2 <- appendoOI x1;
                                    return x2},
                                do {let {x5 = O};
                                    let {x4 = S x5};
...
double_appendoIOIOnline :: MonadPlus m => Term -> Term -> m Term                              
double_appendoIOIOnline x0 x2 = msum [do {guard (x0 == Nil);
                                    x1 <- appendoIO x2;
                                    return x1},
                                do {let {x5 = O};
                                    let {x4 = S x5};
...
double_appendoIOOOnline :: MonadPlus m => Term -> m Term -> m Term -> m Term -> m Term -> m Term -> m Term -> m (Term, Term)
double_appendoIOOOnline x0 gen______appendoOO_x2 gen_____appendoOO_x2 gen____appendoOO_x2 gen___appendoOO_x2 gen__appendoOO_x2 gen_appendoOO_x2 = msum [do {guard (x0 == Nil);
                                                                                                                                                      (x2,
...
______appendoOO = msum [do {let {x1 = Nil};
                        ...
                        do {let {x132 = O};
                            ...
                            let {x1 = Cons x134 x135};
                            return (x0, x1)}]
double_appendoOIIOnline :: MonadPlus m => Term -> Term -> m (Term)
double_appendoOIIOnline x1 x2 = msum [do {appendoII x2 x1;
                                    let {x0 = Nil};
                                    return x0},
                                do {let {x5 = O};
                                    let {x4 = S x5};
...
_______appendoIO x0 = msum [do {let {x1 = Nil};
                                guard (x0 == Nil);
                                return x1}]
double_appendoOIOOnline :: MonadPlus m => Term -> m (Term, Term)
double_appendoOIOOnline x1 = msum [do {let {x0 = Nil};
                                 x2 <- appendoOI x1;
                                 return (x0, x2)},
                             do {let {x5 = O};
                                 let {x4 = S x5};
...
_____appendoAppendoIOO x0 = msum [do {let {x2 = Nil};
                                  ...
                                  do {let {x154 = O};
                                      ...
                                      let {x2 = Cons x155 x3};
                                      return (x1, x2)}]
double_appendoOOIOnline :: MonadPlus m => Term -> m Term -> m (Term, Term)
double_appendoOOIOnline x2 gen______appendoAppendoOIO_x3 = msum [do {let {x0 = Nil};
                                                               x1 <- appendoIO x2;
                                                               return (x0, x1)},
                                                           do {let {x5 = O};
                                                               let {x4 = S x5};
...
_____appendoAppendoOIO x1 gen______appendoAppendoOIO_x3 = msum [do {let {x2 = Nil};
                                                                ...
                                                                do {let {x154 = O};
                                                                    ...
                                                                    x0 <- _______appendoOI x3;
                                                                    return (x0, x2)}]
double_appendoOOOOnline :: MonadPlus m => m Term -> m Term -> m Term -> m Term -> m Term -> m Term -> m Term -> m (Term, Term, Term)
double_appendoOOOOnline gen______appendoOO_x2 gen_____appendoOO_x2 gen____appendoOO_x2 gen___appendoOO_x2 gen__appendoOO_x2 gen_appendoOO_x2 gen_double_appendoOOO_x3 = msum [do {let {x0 = Nil};
                                                                                                                                                                            (x2,
                                                                                                                                                                             x1) <- appendoOO gen_appendoOO_x2;
                                                                                                                                                                            return (x0,
                                                                                                                                                                                    x1,
