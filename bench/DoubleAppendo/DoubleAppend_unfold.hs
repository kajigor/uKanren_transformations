...
tp1 :: Term -> Term -> Term -> [()]
tp1 a b c = (takeS 1) $ double_appendoIII a b c
tp2 :: Term -> Term -> [Term]
tp2 a b = (takeS 1) $ double_appendoIIO a b
tp3 :: Term -> Term -> [Term]
tp3 a c = (takeS 1) $ double_appendoIOI a c
tp4 :: Term -> Term -> [Term]
tp4 b c = (takeS 1) $ double_appendoOII b c
tp5 :: Term -> [(Term, Term)]
tp5 a = (takeS 1) $ double_appendoIOO a
tp6 :: Term -> [(Term, Term)]
tp6 b = (takeS 1) $ double_appendoOIO b
tp7 :: Term -> [(Term, Term)]
tp7 c = (takeS 1) $ double_appendoOOI c
tp8 :: [(Term, Term, Term)]
tp8 = (takeS 1) $ double_appendoOOO 
...
double_appendoOIO x1 = msum [do {let {x4 = O};
                             ...
                             do {let {x2 = Nil};
                                 ...
                                 let {x0 = Cons x997 x998};
                                 return (x0, x2)}]
double_appendoOOI x2 = msum [do {let {x4 = O};
                                 let {x3 = S x4};
                                 let {x8 = O};
                                 let {x7 = S x8};
                                 let {x6 = S x7};
                             ...
                             do {let {x1 = Nil};
                                 ...
                                 let {x0 = Cons x997 x998};
                                 return (x0, x1)}]
double_appendoOOO = msum [do {let {x4 = O};
                              let {x3 = S x4};
                              let {x8 = O};
                              let {x7 = S x8};
                              let {x6 = S x7};
