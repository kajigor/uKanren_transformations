  ...
  [
    bgroup "Ex_depth"
     [
      ...
      , bench "offlineOO" $ nf (eval0 (takeS 10) Ex_Depth_unfold.solveOO) ()
      , bench "onlineII"  $ nf (eval44 (takeS 1) Ex_Depth_cpd_ans.solveII) (y0, y1, gen, gen, gen, gen,
                                                                                    gen, gen, gen, gen,
                                                                                    gen, gen, gen, gen,
                                                                                    gen, gen, gen, gen,
                                                                                    gen, gen, gen, gen,
...
--    ,bgroup "SortGen"
--    [
--        bench "offlineGen"  $ nf (eval26 (takeS 1) double_appendoIIIOnline) $ listGen23 a b c
