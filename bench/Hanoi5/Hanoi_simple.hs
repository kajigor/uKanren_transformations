...
getIIO x0 x1 = Immature $ msum [do {(x3, x4, x5) <- case x1 of
...
one_step2IIIIIII x1 x2 x3 x4 x7 x8 x9 = Immature $ msum [do {let {x26 = Nil};
                                              ...
                                              do {let {x12 = Trueo};
                                                  ...
                                                  return ()}]
lessIII x0 x1 x2 = Immature $ msum [do {x3 <- case x1 of
...
one_step2IOIIIII x1 x3 x4 x7 x8 x9 = Immature $ msum [do {let {x26 = Nil};
                                           ...
                                           do {let {x12 = Trueo};
                                               ...
                                               return x2}]
setIIII x0 x1 x2 x3 = Immature $ msum [do {(x4, x5, x6) <- case x2 of
                                                {Triple y4 y5 y6 -> return (y4, y5, y6);
                                                 _ -> mzero};
                                set2IIIIII x0 x1 x3 x4 x5 x6;
                                return ()}]
setIIIO x0 x1 x2 = Immature $ msum [do {(x4, x5, x6) <- case x2 of
