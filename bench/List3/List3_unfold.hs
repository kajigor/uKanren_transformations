...
tp2 :: [Term]
tp2 = (takeS 1) $ helpIIO a b
tp3 :: [Term]
tp3 = (takeS 1) $ helpIOI a c
tp4 :: [Term]
tp4 = (takeS 1) $ helpOII b c
tp5 :: [(Term, Term)]
tp5 = (takeS 1) $ helpIOO a
tp6 :: [(Term, Term)]
tp6 = (takeS 1) $ helpOIO b
tp7 :: [(Term, Term)]
tp7 = (takeS 1) $ helpOOI c natGen
tp8 :: [(Term, Term, Term)]
tp8 = (takeS 1) $ helpOOO natGen
...
________appendoII x0 x1 = msum [do {let {x274 = Zero};
                                ...
                                do {let {x280 = Zero};
                                    ...
                                    guard (x0 == Nil);
                                    return ()}]
helpIIO :: MonadPlus m => Term -> Term -> m Term
