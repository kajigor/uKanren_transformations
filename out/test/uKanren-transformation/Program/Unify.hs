...
querySame = Program unify $ fresh ["x", "s"] (call "check_uni" [V "x", V "x", V "s", true])

queryAll = Program unify $ fresh ["x", "y", "s"] (call "all_check_uni" [V "5", V "7", V "2", true])

queryGet = Program unify $ fresh ["var", "subst", "q25"] (call "get_term" [V "var", V "subst",  C "some" [V "q25"]])
