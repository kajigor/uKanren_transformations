...
let topLevel y1 y2 =
  ...
  and p_______ z1 z2 = ((fresh (fT fH fN1) (((z1 === (Nat.succ fN1)) &&& ((z2 === (fH % fT)) &&& (p_______ fN1 fT)))))
    |||  (fresh (fT) (((z1 === Nat.zero) &&& (z2 === (!!true % fT))))))
  and p_____ z1 z2 = ((fresh (fZ fSt) (((z1 === fSt) &&& ((z2 === (var fZ)) &&& (p______ fZ fSt)))))
  ...
  and p______ z1 z2 = ((fresh (fT fH fN1) (((z1 === (Nat.succ fN1)) &&& ((z2 === (fH % fT)) &&& (p______ fN1 fT)))))
    |||  (fresh (fT) (((z1 === Nat.zero) &&& (z2 === (!!false % fT))))))
  and p___ z1 z2 = ((fresh (fZ fSt) (((z1 === fSt) &&& ((z2 === (var fZ)) &&& (p____ fZ fSt)))))
    |||  ((fresh (fX__ fSt) (((z1 === fSt) &&& ((z2 === (neg fX__)) &&& (p fSt fX__)))))
  ...
  and p____ z1 z2 = ((fresh (fT fH fN1) (((z1 === (Nat.succ fN1)) &&& ((z2 === (fH % fT)) &&& (p____ fN1 fT)))))
    |||  (fresh (fT) (((z1 === Nat.zero) &&& (z2 === (!!false % fT))))))
  and p_ z1 z2 = ((fresh (fZ fSt) (((z1 === fSt) &&& ((z2 === (var fZ)) &&& (p__ fZ fSt)))))
    |||  ((fresh (fX__ fSt) (((z1 === fSt) &&& ((z2 === (neg fX__)) &&& (p fSt fX__)))))
  ...
  and p__ z1 z2 = ((fresh (fT fH fN1) (((z1 === (Nat.succ fN1)) &&& ((z2 === (fH % fT)) &&& (p__ fN1 fT)))))
    |||  (fresh (fT) (((z1 === Nat.zero) &&& (z2 === (!!false % fT))))))
  in         (p y1 y2)
