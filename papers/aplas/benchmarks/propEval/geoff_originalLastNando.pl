...
p_(St,conj(X___,Y_)) :- p(St,X___),p_(St,Y_).
p_(St,conj(X___,Y_)) :- p_(St,X___),p(St,Y_).
p_(St,conj(X___,Y_)) :- p_(St,X___),p_(St,Y_).
p_(St,disj(X___,Y_)) :- p_(St,X___),p_(St,Y_).
p_(St,neg(X___)) :- p(St,X___).
p_(St,var(Z)) :- p__(Z,St).
p__(o,[false|T]).
p__(s(N1),[H|T]) :- p__(N1,T).
p___(St,conj(X___,Y_)) :- p(St,X___),p___(St,Y_).
p___(St,conj(X___,Y_)) :- p___(St,X___),p(St,Y_).
p___(St,conj(X___,Y_)) :- p___(St,X___),p___(St,Y_).
p___(St,disj(X___,Y_)) :- p___(St,X___),p___(St,Y_).
p___(St,neg(X___)) :- p(St,X___).
