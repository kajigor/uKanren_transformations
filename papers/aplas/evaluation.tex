...
The last two relations are described in~\cite{lozov2019relational} thus we will only briefly describe them here.

We focused on these particular examples because they are

\begin{itemize}
  \item Relational interpreters
  \item Natural
  \item Observable
\end{itemize}
