...
(* let topLevel x0 x1 =
let rec _evalo y2 y3 = (fresh (q1 q2 q3 q4 q5 q6) ((((y2 === conj q1 q2) &&& (evaloEvalo y3 q1 q2)) ||| (((y2 === disj q1 q2) &&& ((evaloEvalo y3 q1 q2) ||| (((__evalo y3 q1) &&& (_evalo q2 y3)) ||| (___evaloEvalo y3 q1 q2)))) ||| (((y2 === neg q1) &&& (__evalo y3 q1)) ||| ((y2 === var q3) &&& (((q3 === Std.Nat.zero) &&& (y3 === (Std.(%) (!!true) (q4)))) ||| (((q3 === (Std.Nat.succ (q5))) &&& (y3 === (Std.(%) (q6) (q4)))) &&& (_elemo q4 q5)))))))))
...
let topLevel x0 x1 =
  let rec _evalo y2 y3 =
    fresh (q1 q2 q3)
      ...
      ||| ( y2 === disj q1 q2
          &&& ( evaloEvalo y3 q1 q2
              ||| (__evalo y3 q1 &&& _evalo q2 y3 ||| ___evaloEvalo y3 q1 q2)
              )
  ...
  and __evalo y7 y8 =
    fresh (q1 q2 q3)
      ( y8 === conj q1 q2
      &&& ( _evaloEvalo y7 q1 q2
          ||| (_evalo q1 y7 &&& __evalo y7 q2 ||| __evaloEvalo y7 q1 q2) )
