...
let topLevel x0 x1 =
  let rec _evalo y2 y3 =
    fresh (q1 q2 q3 q4 q5 q6)
      ...
      ||| ( y2 === disj q1 q2
          &&& ( _evalo q1 y3 &&& _evalo q2 y3
              ||| (__evalo y3 q1 &&& _evalo q2 y3 ||| _evalo q1 y3 &&& __evalo y3 q2)
              )
  ...
  and __evalo y7 y8 =
    fresh (q1 q2 q3 q4 q5 q6)
      ( y8 === conj q1 q2
      &&& ( __evalo y7 q1 &&& _evalo q2 y7
          ||| (_evalo q1 y7 &&& __evalo y7 q2 ||| __evalo y7 q1 &&& __evalo y7 q2) )
