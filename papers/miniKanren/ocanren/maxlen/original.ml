...
let topLevel x0 x1 x2 =
  ...
  and maxo1 x n m =
    x === Std.List.nil () &&& (m === n)
    ||| (fresh (z t h) (x === Std.( % ) h t &&& (leo h n !!true &&& maxo1 t n m)) ||| fresh (z t h) (x === Std.( % ) h t &&& (gto h n !!true &&& maxo1 t h m)))
  and leo x y b =
  ...
  and lengtho x l = x === Std.List.nil () &&& (l === Std.Nat.zero) ||| fresh (z t h) (x === Std.( % ) h t &&& (l === Std.Nat.succ z &&& lengtho t z)) in
  maxLengtho x0 x1 x2
