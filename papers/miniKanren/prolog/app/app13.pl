...
appendo(cons(Q1, cons(Q4, cons(Q7, cons(Q10, cons(Q13, cons(Q16, cons(Q19, cons(Q22, cons(Q25, cons(Q28, cons(Q31, cons(Q34, cons(Q37, cons(Q40, Q41)))))))))))))), Y1, cons(Q1, cons(Q4, cons(Q7, cons(Q10, cons(Q13, cons(Q16, cons(Q19, cons(Q22, cons(Q25, cons(Q28, cons(Q31, cons(Q34, cons(Q37, cons(Q40, Q42))))))))))))))) :- _appendo(Y1, Q41, Q42).
_appendo(Y5, nil, Y5).
