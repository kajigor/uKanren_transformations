...
appendo(cons(Q1, cons(Q4, cons(Q7, cons(Q10, cons(Q13, cons(Q16, cons(Q19, cons(Q22, cons(Q25, cons(Q28, cons(Q31, cons(Q34, cons(Q37, cons(Q40, cons(Q43, nil))))))))))))))), Q45, cons(Q1, cons(Q4, cons(Q7, cons(Q10, cons(Q13, cons(Q16, cons(Q19, cons(Q22, cons(Q25, cons(Q28, cons(Q31, cons(Q34, cons(Q37, cons(Q40, cons(Q43, Q45)))))))))))))))).
appendo(cons(Q1, cons(Q4, cons(Q7, cons(Q10, cons(Q13, cons(Q16, cons(Q19, cons(Q22, cons(Q25, cons(Q28, cons(Q31, cons(Q34, cons(Q37, cons(Q40, cons(Q43, cons(Q46, Q47)))))))))))))))), Y1, cons(Q1, cons(Q4, cons(Q7, cons(Q10, cons(Q13, cons(Q16, cons(Q19, cons(Q22, cons(Q25, cons(Q28, cons(Q31, cons(Q34, cons(Q37, cons(Q40, cons(Q43, cons(Q46, Q48))))))))))))))))) :- _appendo(Y1, Q47, Q48).
_appendo(Y5, nil, Y5).
