...
appendo(cons(Q1, cons(Q4, cons(Q7, cons(Q10, cons(Q13, cons(Q16, cons(Q19, Q20))))))), Y1, cons(Q1, cons(Q4, cons(Q7, cons(Q10, cons(Q13, cons(Q16, cons(Q19, Q21)))))))) :- _appendo(Y1, Q20, Q21).
_appendo(Y5, nil, Y5).
