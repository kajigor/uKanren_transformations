...
appendo(cons(Q1, cons(Q4, cons(Q7, cons(Q10, cons(Q13, cons(Q16, cons(Q19, cons(Q22, cons(Q25, cons(Q28, Q29)))))))))), Y1, cons(Q1, cons(Q4, cons(Q7, cons(Q10, cons(Q13, cons(Q16, cons(Q19, cons(Q22, cons(Q25, cons(Q28, Q30))))))))))) :- _appendo(Y1, Q29, Q30).
_appendo(Y5, nil, Y5).
