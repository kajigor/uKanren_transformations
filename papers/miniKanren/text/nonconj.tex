...
\db{The algorithm pseudocode is shown on Fig.~\ref{fig:ncpd-pseudo}\footnote{
    \db{For the sake of breavity and clarity, we provide functions \texttt{drive\_disj} and \texttt{drive\_conj} describing driving processes for disjunction and conjunction correspondly. Driving itself if a trivial combination of presented functions (line 2)}}}.
