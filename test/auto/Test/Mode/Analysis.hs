...
unit_unifyAnalysis = do
  ...
  let actual = evalStateT (prioritizeGround (N.Disj (N.Conj (N.Unif (Var (0, groundMode)) (FTVar (Var (1, freeMode))) :| []) :| []))) (emptyAnalyzeState Nothing) :: Either ModeAnalysisError (N.Goal (Int, Mode))
