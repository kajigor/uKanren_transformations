...
unit_normSyntax = do
  runTest
    ...
    (Program {getDefs = [Def {getName = "topLevel0", getArgs = [1,2], getBody = Disj (Conj (Call "a" [Var {getVar = 2}] :| []) :| [Conj (Call "b" [Var {getVar = 1}] :| [])])}], getGoal = Disj (Conj (Call "addo" [Var {getVar = 0},Var {getVar = 1},Var {getVar = 2}] :| [Call "topLevel0" [Var {getVar = 1},Var {getVar = 2}]]) :| [])})
  ...
  runTest
    ...
    Program {getDefs = [Def {getName = "topLevel0", getArgs = [0,1,2], getBody = Disj (Conj (Call "a" [Var {getVar = 2}] :| []) :| [Conj (Call "addo" [Var {getVar = 0},Var {getVar = 1},Var {getVar = 2}] :| [Call "topLevel00" [Var {getVar = 1},Var {getVar = 2}]])])},Def {getName = "topLevel00", getArgs = [1,2], getBody = Disj (Conj (Call "a" [Var {getVar = 2}] :| []) :| [Conj (Call "b" [Var {getVar = 1}] :| [])])}], getGoal = Disj (Conj (Call "addo" [Var {getVar = 0},Var {getVar = 1},Var {getVar = 2}] :| [Call "topLevel0" [Var {getVar = 0},Var {getVar = 1},Var {getVar = 2}]]) :| [])}
...
unit_clashingRelationNames = do
  ...
  runTest
    ...
    Program {
      getDefs =
        [ Def "f"   [0] (Disj (Conj (Call "f1"  [Var 0] :| [Call "f2" [Var 0]]) :| []))
        , Def "f0"  [0] (Disj (Conj (Call "f02" [Var 0] :| [Call "f03" [Var 0]]) :| []))
        , Def "f02" [0] (Disj (Conj (Call "f"   [Var 0] :| []) :| [Conj (Call "f" [Var 0] :| [])]))
        , Def "f03" [0] (Disj (Conj (Call "f"   [Var 0] :| []) :| [Conj (Call "f" [Var 0] :| [])]))
        , Def "f1"  [0] (Disj (Conj (Call "f"   [Var 0] :| []) :| [Conj (Call "f" [Var 0] :| [])]))
        , Def "f2"  [0] (Disj (Conj (Call "f"   [Var 0] :| []) :| [Conj (Call "f" [Var 0] :| [])]))
        ],
      getGoal = Disj (Conj (Call "f" [Var 0] :| []) :| [])}
...
unit_freshVarsInDisj = do
  runTest
    ...
    Program {
      getDefs =
        [ Def "f" [0, 1] (Disj (Conj (Unif (Var 0) (FTCon "pair" [Var 2, Var 3]) :| [Call "f0" [Var 1, Var 2, Var 3]]) :| []))
        , Def "g" [0, 1] (Disj (Conj (Unif (Var 0) (FTVar $ Var 1) :| []) :| []))
        , Def "f0" [1, 2, 3] (Disj (Conj (Call "g" [Var 1, Var 2] :| []) :| [Conj (Call "g" [Var 1, Var 3] :| [])]))],
      getGoal = Disj (Conj (Call "f" [Var 0, Var 1] :| []) :| [])}
