...
filter (dynamic static static dynamic dynamic) 
 newo t prefix postfix new_prefix new_postfix = (fresh rem_postfix in (((postfix == (t :: new_postfix) & Unfold appendo prefix [t] new_prefix) | (fresh h, temp, rest, s0 in ((postfix == (h :: rem_postfix) & Unfold appendo prefix [t] temp & Unfold appendo new_prefix rest prefix & Unfold appendo s0 new_prefix temp & Unfold appendo rest ((h :: rem_postfix)) new_postfix))))));
