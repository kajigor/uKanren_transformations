 ...
 newo t prefix postfix new_prefix new_postfix = 
 	(fresh rem_postfix in 
		(((postfix == (t :: new_postfix) & 
		   Unfold appendo1 prefix [t] new_prefix) | 
		(fresh h, temp, rest, s0 in 
		   ((postfix == (h :: rem_postfix) & 
		     Unfold appendo1 prefix [t] temp & 
			 Unfold appendo2 new_prefix rest prefix & 
			 Unfold appendo2 s0 new_prefix temp & 
			 Unfold appendo1 rest ((h :: rem_postfix)) new_postfix))))));
