...
data Term
    ...
    deriving (Show, Eq)
helpOO gen_clausIO_x6 gen_helpOO_x51 = msum [do {let {x52 = O};
                                                 let {x56 = O};
                                                 let {x55 = S x56};
                                                 let {x54 = S x55};
                                                 let {x59 = O};
                                                 ...
                                                 return (x0, x1)}]
solveIO x0 gen_clausIO_x6 = msum [do {let {x49 = O};
                                      x1 <- solve1IIO x0 x49 gen_clausIO_x6;
                                      return x1}]
solve1IIO x0 x1 gen_clausIO_x6 = msum [do {guard (x0 == Nil);
                                           let {x2 = x1};
                                           return x2},
                                       do {let {x8 = S x1};
                                           (x3, x4) <- case x0 of
                                           ...
                                           return x2}]
clausIO x0 gen_clausIO_x6 = msum [do {let {x1 = Nil};
                                      (x2, x4) <- case x0 of
