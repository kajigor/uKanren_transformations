...
flipI x0 = msum [do {let {x8 = A};
                     ...
                     guard (x20 == x16);
                     return ()}]
flipflipO = msum [do {let {x3 = D};
                      let {x4 = x3};
                      x1 <- flipO;
                      x2 <- _flipO;
                      let {x0 = Tree x1 x4 x2};
                      return x0}]
_flipO = msum [do {let {x22 = F};
                   let {x21 = Leaf x22};
                   let {x23 = R};
                   let {x25 = C};
                   let {x24 = Leaf x25};
