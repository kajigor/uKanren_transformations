module MatchSimple_clean where
...
data Term
    ...
    | S Term
    deriving (Show, Eq)
matchOI x1 gen_match10OIOIOI_x6 gen_match1OIOI_x2 gen_neqOI_x2 = msum [do {let {x11 = x1};
                                                                           (x0,
                                                                            x10) <- match1OIOI x1 x11 gen_match10OIOIOI_x6 gen_match1OIOI_x2 gen_neqOI_x2;
                                                                           guard (x10 == x0);
                                                                           return x0}]
match1OIOI x1 x3 gen_match10OIOIOI_x6 gen_match1OIOI_x2 gen_neqOI_x2 = msum [do {let {x0 = Nil};
                                                                             ...
                                                                             do {(x5,
                                                                                 ...
                                                                                 let {x0 = Cons x4 x6};
                                                                                 return (x0, x2)}]
match10OIOIOI x3 x5 x7 gen_match10OIOIOI_x6 gen_match1OIOI_x2 gen_neqOI_x2 = msum [do {let {x4 = x5};
                                                                                       (x6,
                                                                                   ...
                                                                                   do {(x8,
                                                                                       ...
                                                                                       return (x2,
                                                                                               x4,
                                                                                               x6)}]
neqOI x1 gen_neqOI_x2 = msum [do {guard (x1 == O);
