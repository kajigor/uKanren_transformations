...
data Term
    ...
    | Star Term
    deriving (Show, Eq)
helpIIIIO x0 x1 x2 x3 gen_generate1IOIIO_x4 = msum [do {let {x11 = Char x0};
                                                        let {x12 = Char x1};
                                                        let {x10 = Or x11 x12};
                                                        let {x14 = Char x2};
                                                        let {x15 = Char x3};
                                                        ...
                                                        return x4}]
generateIOI x0 x2 gen_generate1IOIIO_x4 = msum [do {guard (x0 == Empty);
                                                    let {x1 = x2};
                                                    return x1},
                                                do {x3 <- case x0 of
                                                ...
                                                do {x3 <- case x0 of
                                                    ...
                                                    return x1}]
generate0OIII x2 x3 x4 gen_generate1IOIIO_x4 = msum [do {x1 <- generateIOI x3 x2 gen_generate1IOIIO_x4;
                                                         return x1},
                                                     do {x1 <- generateIOI x4 x2 gen_generate1IOIIO_x4;
                                                         return x1}]
generate1IOIIO x0 x2 x3 gen_generate1IOIIO_x4 = msum [do {let {x1 = x2};
