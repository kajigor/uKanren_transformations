...
data Term
    ...
    | Zero
    deriving (Show, Eq)
rrOI x1 gen_g0IOOOI_x2 gen_g0IOOOI_x3 gen_neq0IO_x2 = msum [do {x2 <- fOI x1 gen_g0IOOOI_x2 gen_g0IOOOI_x3 gen_neq0IO_x2;
                                                                x0 <- fOI x2 gen_g0IOOOI_x2 gen_g0IOOOI_x3 gen_neq0IO_x2;
                                                                return x0}]
fOI x1 gen_g0IOOOI_x2 gen_g0IOOOI_x3 gen_neq0IO_x2 = msum [do {let {x0 = Nil};
                                                               guard (x1 == Nil);
                                                               return x0},
                                                           do {(x2,
                                                               ...
                                                               let {x0 = Cons x2 x3};
                                                               return x0}]
hOOI x2 gen_g0IOOOI_x2 gen_g0IOOOI_x3 gen_neq0IO_x2 = msum [do {let {x1 = Nil};
                                                                let {x7 = Nil};
                                                                (x8, x9) <- case x2 of
                                                                            {Cons y8
                                                                                  y9 -> return (y8,
                                                            ...
                                                            do {(x0,
                                                                ...
                                                                guard (x1 == Cons x3 x4);
                                                                return (x0, x1)}]
gOOOOI x4 gen_g0IOOOI_x2 gen_g0IOOOI_x3 gen_neq0IO_x2 = msum [do {(x5,
                                                                   x6) <- case x4 of
                                                                  ...
                                                                  return (x0, x1, x2, x3)}]
g0IOOOI x0 x6 gen_g0IOOOI_x2 gen_g0IOOOI_x3 gen_neq0IO_x2 = msum [do {let {x1 = x0};
                                                                  ...
                                                                  do {x1 <- neqIO x0 gen_neq0IO_x2;
                                                                      ...
                                                                      x3 <- gen_g0IOOOI_x3;
                                                                      return (x1, x2, x3)}]
neqIO x0 gen_neq0IO_x2 = msum [do {x1 <- neq0IO x0 gen_neq0IO_x2;
                                   return x1},
                               do {x2 <- case x0 of
                                   ...
                                   let {x1 = Succ x3};
                                   return x1}]
neq0IO x0 gen_neq0IO_x2 = msum [do {guard (x0 == Zero);
