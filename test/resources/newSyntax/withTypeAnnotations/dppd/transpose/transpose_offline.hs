...
data Term
    ...
    | S Term
    deriving (Show, Eq)
transposedsI x0 = msum [do {let {x4 = O};
                            let {x7 = O};
                            let {x6 = S x7};
                            let {x10 = O};
                            let {x9 = S x10};
                            ...
                            x16 <- case x13 of
                                   {Cons y14 y16 -> do {guard (x14 == y14); return y16};
                                    _ -> mzero};
                            x20 <- case x16 of
                                   {Cons y17 y20 -> do {guard (x17 == y17); return y20};
                                    _ -> mzero};
                            x1 <- case x20 of
                                  {Cons y21 y1 -> do {guard (x21 == y21); return y1}; _ -> mzero};
                            x25 <- case x24 of
                                   {Cons y25 y33 -> do {guard (x33 == y33); return y25};
                                    _ -> mzero};
                            x29 <- case x25 of
                            ...
                            nullrowsdII x1 x2;
                            return ()}]
nullrowsdII x0 x1 = msum [do {guard (x1 == Nil);
                              guard (x0 == Nil);
                              return ()}]
transposedsO = msum [do {let {x4 = O};
                         let {x7 = O};
                         let {x6 = S x7};
                         let {x10 = O};
                         let {x9 = S x10};
                         ...
                         let {x0 = Cons x34 x35};
                         return x0}]
nullrowsdOO = msum [do {let {x1 = Nil};
                        let {x0 = Nil};
                        return (x0, x1)}]