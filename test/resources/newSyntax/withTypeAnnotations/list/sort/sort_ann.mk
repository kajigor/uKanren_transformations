filter (static dynamic)
 sorto lst reslst = ((lst == [] & reslst == []) | (fresh h, t, l, r, g, lres, rres in ((lst == (h :: t) & Unfold splito h t l r & Memo sorto l lres & Memo sorto r rres & Unfold appendo lres ((h :: rres)) reslst))));
